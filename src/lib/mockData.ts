...
export const mockResumeFullStackDev: ResumeData = {
  header: {
  ...
  summary: {
    about_me:
      "Full-stack developer with 5+ years of experience building scalable web applications using TypeScript, React, and Node.js. Passionate about clean code, robust architecture, and delivering exceptional user experiences. Seeking challenging roles in innovative tech environments.",
  },
  tech_skills: {
  ...
  work_exp: [
    ...
    },
    {
      ...
      b2: "Migrated legacy Python 2 codebase to Python 3, reducing technical debt and improving application performance.",
    },
  ],
  projects: [
    {
