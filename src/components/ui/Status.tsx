...
const VARIANT_STYLES = {
  ...
  loading: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400 border-blue-200 dark:border-blue-800",
};

export function Status({ variant = "default", message, className }: StatusProps) {
  ...
  return (
    ...
    >
      {Icon && (
        <Icon
          className={cn("h-5 w-5 shrink-0", variant === "loading" && "animate-spin")}
        />
      )}
