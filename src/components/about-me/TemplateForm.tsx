...
export function TemplateForm({
    ...
    useEffect(() => {
        ...
        setWorkExperiences(
            Array.isArray(initial.workExperiences)
                        ...
                        >
                            ...
                            <Button
                                ...
                                onClick={() => {
                                    ...
                                    const next = currentSkills.filter(
                                        (_, idx) => idx !== i,
                                    );
            ...
            <div className="flex flex-col gap-2 w-full">
                <div className="flex items-center gap-2">
                    ...
                    <Button
                        ...
                        onClick={() =>
                            handleModal(ModalType.WorkExperience, null)
                        }
                    >
                        add
                    </Button>
                        ...
                        >
                            ...
                            <div className="mt-1 flex gap-2">
                                <Button
                                    ...
                                    variant="ghost"
                                    onClick={() =>
                                        handleModal(ModalType.WorkExperience, i)
                                    }
                                >
                                    edit
                                </Button>
                        ...
                        >
                            ...
                            <div className="mt-1 flex gap-2">
                                <Button
                                    ...
                                    variant="ghost"
                                    onClick={() =>
                                        handleModal(ModalType.Education, i)
                                    }
                                >
                                    edit
                                </Button>
                        ...
                        >
                            ...
                            <div className="mt-1 flex gap-2">
                                <Button
                                    ...
                                    variant="ghost"
                                    onClick={() =>
                                        handleModal(ModalType.Project, i)
                                    }
                                >
                                    edit
                                </Button>
